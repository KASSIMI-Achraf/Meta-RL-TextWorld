...
The r_2 and the r_3 and the r_4 and the r_6 and the r_5 and the r_8 and the r_7 and the r_9 and the r_0 and the r_1 are rooms.
...
The basement part 0 is some text that varies. The basement part 0 is "You are in a basement. An ordinary one.
 ...
 You make out a safe.[if c_0 is open and there is something in the c_0] The safe contains [a list of things in the c_0]. You wonder idly who left that here.[end if]".
...
The basement part 2 is some text that varies. The basement part 2 is " You see a chest. I mean, just wow! Isn't TextWorld just the best?[if c_1 is open and there is something in the c_1] The chest contains [a list of things in the c_1].[end if]".
The basement part 3 is some text that varies. The basement part 3 is "[if c_1 is open and the c_1 contains nothing] The chest is empty! What a waste of a day![end if]".
The basement part 4 is some text that varies. The basement part 4 is " You scan the room, seeing a trunk. You shudder, but continue examining the room.[if c_2 is open and there is something in the c_2] The trunk contains [a list of things in the c_2].[end if]".
The basement part 5 is some text that varies. The basement part 5 is "[if c_2 is open and the c_2 contains nothing] The trunk is empty! This is the worst thing that could possibly happen, ever![end if]".
The basement part 6 is some text that varies. The basement part 6 is " Look out! It's a- oh, never mind, it's just a rack. The rack is standard.[if there is something on the s_0] On the rack you can see [a list of things on the s_0]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
The basement part 7 is some text that varies. The basement part 7 is "[if there is nothing on the s_0] Looks like someone's already been here and taken everything off it, though. Silly rack, silly, empty, good for nothing rack.[end if]".
The basement part 8 is some text that varies. The basement part 8 is "

 There is [if d_2 is open]an open[otherwise]a closed[end if]".
The basement part 9 is some text that varies. The basement part 9 is " portal leading south. There is [if d_1 is open]an open[otherwise]a closed[end if]".
The basement part 10 is some text that varies. The basement part 10 is " passageway leading west.".
The description of r_2 is "[basement part 0][basement part 1][basement part 2][basement part 3][basement part 4][basement part 5][basement part 6][basement part 7][basement part 8][basement part 9][basement part 10]".
...
The workshop part 2 is some text that varies. The workshop part 2 is " passageway leading east. There is an exit to the south. Don't worry, it is unguarded. You need an unblocked exit? You should try going west.".
...
The canteen part 0 is some text that varies. The canteen part 0 is "You arrive in a canteen. A normal kind of place.
 ...
 You scan the room for a platter, and you find a platter. [if there is something on the s_1]You see [a list of things on the s_1] on the platter.[end if]".
The canteen part 1 is some text that varies. The canteen part 1 is "[if there is nothing on the s_1]Unfortunately, there isn't a thing on it. What, you think everything in TextWorld should have stuff on it?[end if]".
...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "You're now in a cookhouse.
 ...
 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The cookhouse part 1 is some text that varies. The cookhouse part 1 is " hatch leading south. There is an unblocked exit to the east. There is an unblocked exit to the west.".
...
The salon part 0 is some text that varies. The salon part 0 is "You've just sauntered into a salon.
 ...
 Hey, want to see a locker? Look over there, a locker. Huh, weird.[if c_3 is open and there is something in the c_3] The locker contains [a list of things in the c_3].[end if]".
...
The salon part 2 is some text that varies. The salon part 2 is " If you haven't noticed it already, there seems to be something there by the wall, it's a mantelpiece. [if there is something on the s_2]You see [a list of things on the s_2] on the mantelpiece. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
The salon part 3 is some text that varies. The salon part 3 is "[if there is nothing on the s_2]But there isn't a thing on it. Oh! Why couldn't there just be stuff on it?[end if]".
...
The shower part 1 is some text that varies. The shower part 1 is "[if c_4 is open and the c_4 contains nothing] The dresser is empty! This is the worst thing that could possibly happen, ever![end if]".
The shower part 2 is some text that varies. The shower part 2 is " You can make out a bench. [if there is something on the s_3]On the bench you make out [a list of things on the s_3].[end if]".
The shower part 3 is some text that varies. The shower part 3 is "[if there is nothing on the s_3]But the thing hasn't got anything on it. Oh! Why couldn't there just be stuff on it?[end if]".
...
The recreation zone part 1 is some text that varies. The recreation zone part 1 is " basket in the corner.[if c_5 is open and there is something in the c_5] The basket contains [a list of things in the c_5].[end if]".
The recreation zone part 2 is some text that varies. The recreation zone part 2 is "[if c_5 is open and the c_5 contains nothing] The basket is empty! This is the worst thing that could possibly happen, ever![end if]".
...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You're now in the kitchen.
 ...
 There is [if d_2 is open]an open[otherwise]a closed[end if]".
The kitchen part 1 is some text that varies. The kitchen part 1 is " portal leading north. There is an exit to the south. Don't worry, it is unblocked.".
...
The r_2 and the r_3 and the r_4 and the r_6 and the r_5 and the r_8 and the r_7 and the r_9 and the r_0 and the r_1 are rooms.
The r_2 and the r_3 and the r_4 and the r_6 and the r_5 and the r_8 and the r_7 and the r_9 and the r_0 and the r_1 are privately-named.
...
Test quest0_0 with "go west / go west / go north / go east / open hatch / go south / go south / go west / go north / take latchkey"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another fast paced game of TextWorld! Your first objective is to make an attempt to venture west. Then, head south. Following that, make an effort to go to the west. With that accomplished,".
The objective part 1 is some text that varies. The objective part 1 is " attempt to go north. With that done, retrieve the latchkey from the floor of the canteen. Got that? Good!".
