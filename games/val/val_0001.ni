...
The r_1 and the r_4 and the r_2 and the r_5 and the r_7 and the r_6 and the r_8 and the r_9 and the r_0 and the r_3 are rooms.
...
The laundromat part 0 is some text that varies. The laundromat part 0 is "You're now in the laundromat.
 ...
 You smell a terrible smell, and follow it to a shelf. [if there is something on the s_0]You see [a list of things on the s_0] on the shelf.[end if]".
The laundromat part 1 is some text that varies. The laundromat part 1 is "[if there is nothing on the s_0]However, the shelf, like an empty shelf, has nothing on it. Hm. Oh well[end if]".
...
The laundromat part 4 is some text that varies. The laundromat part 4 is " passageway leading west. You need an unblocked exit? You should try going south.".
...
The cellar part 0 is some text that varies. The cellar part 0 is "You find yourself in a cellar. An usual kind of place.
 ...
 You see a gleam over in a corner, where you can see a case. You can't wait to tell the folks at home about this![if c_0 is open and there is something in the c_0] The case contains [a list of things in the c_0]. You can't wait to tell the folks at home about this![end if]".
The cellar part 1 is some text that varies. The cellar part 1 is "[if c_0 is open and the c_0 contains nothing] What a letdown! The case is empty![end if]".
The cellar part 2 is some text that varies. The cellar part 2 is " You can see a cabinet, so there's that.[if c_1 is open and there is something in the c_1] The cabinet contains [a list of things in the c_1].[end if]".
The cellar part 3 is some text that varies. The cellar part 3 is "[if c_1 is open and the c_1 contains nothing] The cabinet is empty, what a horrible day![end if]".
The cellar part 4 is some text that varies. The cellar part 4 is "

 There is [if d_3 is open]an open[otherwise]a closed[end if]".
The cellar part 5 is some text that varies. The cellar part 5 is " portal leading south. There is [if d_1 is open]an open[otherwise]a closed[end if]".
The cellar part 6 is some text that varies. The cellar part 6 is " passageway leading east. There is an exit to the west. Don't worry, it is unguarded.".
...
south of r_4 and north of r_7 is a door called d_3.
...
The basement part 0 is some text that varies. The basement part 0 is "Well, here we are in the basement.
 ...
 Oh wow! Is that what I think it is? It is! It's a toolbox.[if c_2 is open and there is something in the c_2] The toolbox contains [a list of things in the c_2].[end if]".
...
The basement part 2 is some text that varies. The basement part 2 is "
 ...
 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The basement part 3 is some text that varies. The basement part 3 is " gateway leading west. There is an exit to the south. Don't worry, it is unguarded.".
...
The dish-pit part 0 is some text that varies. The dish-pit part 0 is "You are in a dish-pit. A standard kind of place.
 ...
 You can see a plate. [if there is something on the s_1]On the plate you see [a list of things on the s_1]. Now that's what I call TextWorld![end if]".
...
The cookery part 1 is some text that varies. The cookery part 1 is " freezer in the room.[if c_3 is open and there is something in the c_3] The freezer contains [a list of things in the c_3]. Wow, isn't TextWorld just the best?[end if]".
The cookery part 2 is some text that varies. The cookery part 2 is "[if c_3 is open and the c_3 contains nothing] The freezer is empty! This is the worst thing that could possibly happen, ever![end if]".
The cookery part 3 is some text that varies. The cookery part 3 is "

 There is [if d_3 is open]an open[otherwise]a closed[end if]".
The cookery part 4 is some text that varies. The cookery part 4 is " portal leading north. There is [if d_2 is open]an open[otherwise]a closed[end if]".
The cookery part 5 is some text that varies. The cookery part 5 is " hatch leading south. There is an exit to the west. Don't worry, it is unguarded.".
...
north of r_7 and south of r_4 is a door called d_3.
...
The bedchamber part 0 is some text that varies. The bedchamber part 0 is "Well I'll be, you are in a place we're calling a bedchamber. The room is well lit.

 [if c_4 is locked]A locked[else if c_4 is open]An open[otherwise]A closed[end if]".
The bedchamber part 1 is some text that varies. The bedchamber part 1 is " ordinary looking basket is in the room.[if c_4 is open and there is something in the c_4] The basket contains [a list of things in the c_4].[end if]".
The bedchamber part 2 is some text that varies. The bedchamber part 2 is "[if c_4 is open and the c_4 contains nothing] The basket is empty! What a waste of a day![end if]".
The bedchamber part 3 is some text that varies. The bedchamber part 3 is "

 There is [if d_2 is open]an open[otherwise]a closed[end if]".
The bedchamber part 4 is some text that varies. The bedchamber part 4 is " hatch leading north. You don't like doors? Why not try going west, that entranceway is unblocked.".
...
The shower part 0 is some text that varies. The shower part 0 is "You've just walked into a shower. You begin to take stock of what's in the room.
 ...
 You smell a lovely smell, and follow it to a table. The table is standard.[if there is something on the s_2] On the table you can see [a list of things on the s_2].[end if]".
...
The scullery part 1 is some text that varies. The scullery part 1 is "[if there is nothing on the s_3]Unfortunately, there isn't a thing on it. What, you think everything in TextWorld should have stuff on it?[end if]".
...
The r_1 and the r_4 and the r_2 and the r_5 and the r_7 and the r_6 and the r_8 and the r_9 and the r_0 and the r_3 are rooms.
The r_1 and the r_4 and the r_2 and the r_5 and the r_7 and the r_6 and the r_8 and the r_9 and the r_0 and the r_3 are privately-named.
...
The s_2 is in r_9.
The description of s_3 is "The platter is reliable.".
...
Test quest0_0 with "go west / go west / go south / go east / open portal / go north / go east / open gateway / go east / take passkey"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is your task for today. First off, assure that the gateway inside the laundromat is wide open. After that, make an effort to travel east. And then, pick-up the passkey from ".
The objective part 1 is some text that varies. The objective part 1 is "the floor of the basement. Once that's all handled, you can stop!".
