...
The r_0 and the r_1 and the r_2 and the r_3 and the r_4 and the r_7 and the r_6 and the r_8 and the r_5 and the r_9 are rooms.
...
The playroom part 1 is some text that varies. The playroom part 1 is " locker nearby.[if c_0 is open and there is something in the c_0] The locker contains [a list of things in the c_0].[end if]".
The playroom part 2 is some text that varies. The playroom part 2 is "[if c_0 is open and the c_0 contains nothing] The locker is empty! What a waste of a day![end if]".
The playroom part 3 is some text that varies. The playroom part 3 is "

 There is [if d_1 is open]an open[otherwise]a closed[end if]".
The playroom part 4 is some text that varies. The playroom part 4 is " gate leading west. You need an unblocked exit? You should try going east.".
...
The bedroom part 1 is some text that varies. The bedroom part 1 is " normal looking trunk is here.[if c_1 is open and there is something in the c_1] The trunk contains [a list of things in the c_1]. Classic TextWorld.[end if]".
The bedroom part 2 is some text that varies. The bedroom part 2 is "[if c_1 is open and the c_1 contains nothing] The trunk is empty, what a horrible day![end if]".
The bedroom part 3 is some text that varies. The bedroom part 3 is " You can make out a safe. You check the price tag that's still affixed to the safe. 25 bucks? What a deal! You'll have to ask where they got this![if c_2 is open and there is something in the c_2] The safe contains [a list of things in the c_2]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
The bedroom part 4 is some text that varies. The bedroom part 4 is "[if c_2 is open and the c_2 contains nothing] The safe is empty! This is the worst thing that could possibly happen, ever![end if]".
The bedroom part 5 is some text that varies. The bedroom part 5 is "

 There is [if d_1 is open]an open[otherwise]a closed[end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is " gate leading east. You need an unblocked exit? You should try going north. There is an unguarded exit to the west.".
...
The cookery part 0 is some text that varies. The cookery part 0 is "Well, here we are in a cookery.
 ...
 Were you looking for a rack? Because look over there, it's a rack. [if there is something on the s_0]On the rack you can make out [a list of things on the s_0].[end if]".
...
The cookery part 2 is some text that varies. The cookery part 2 is " Were you looking for a plate? Because look over there, it's a plate. [if there is something on the s_1]You see [a list of things on the s_1] on the plate. I mean, just wow! Isn't TextWorld just the best?[end if]".
The cookery part 3 is some text that varies. The cookery part 3 is "[if there is nothing on the s_1]Unfortunately, there isn't a thing on it. Oh! Why couldn't there just be stuff on it?[end if]".
...
The pantry part 0 is some text that varies. The pantry part 0 is "You arrive in a pantry.
 ...
 Look over there! a chest. Hmmm... what else, what else?[if c_3 is open and there is something in the c_3] The chest contains [a list of things in the c_3].[end if]".
...
The pantry part 2 is some text that varies. The pantry part 2 is " You rest your hand against a wall, but you miss the wall and fall onto a case.[if c_4 is open and there is something in the c_4] The case contains [a list of things in the c_4].[end if]".
...
The study part 0 is some text that varies. The study part 0 is "You've just sauntered into a study.
 ...
 You can make out a shelf. [if there is something on the s_2]On the shelf you see [a list of things on the s_2]. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
The study part 1 is some text that varies. The study part 1 is "[if there is nothing on the s_2]But the thing is empty. It would have been so cool if there was stuff on the shelf.[end if]".
The study part 2 is some text that varies. The study part 2 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The study part 3 is some text that varies. The study part 3 is " hatch leading north. You don't like doors? Why not try going east, that entranceway is unguarded. There is an exit to the south. Don't worry, it is unblocked.".
...
The basement part 0 is some text that varies. The basement part 0 is "You arrive in a basement. An usual one. You begin to take stock of what's in the room.

 You make out a toolbox. You shudder, but continue examining the room.[if c_5 is open and there is something in the c_5] The toolbox contains [a list of things in the c_5].[end if]".
...
The parlor part 0 is some text that varies. The parlor part 0 is "You find yourself in a parlor. A normal kind of place.
 ...
 You can make out a bench. The bench is typical.[if there is something on the s_3] On the bench you can see [a list of things on the s_3].[end if]".
...
The parlor part 2 is some text that varies. The parlor part 2 is "
 ...
 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The parlor part 3 is some text that varies. The parlor part 3 is " hatch leading south. You need an unblocked exit? You should try going east. You need an unguarded exit? You should try going north.".
...
The r_0 and the r_1 and the r_2 and the r_3 and the r_4 and the r_7 and the r_6 and the r_8 and the r_5 and the r_9 are rooms.
The r_0 and the r_1 and the r_2 and the r_3 and the r_4 and the r_7 and the r_6 and the r_8 and the r_5 and the r_9 are privately-named.
...
Test quest0_0 with "open gate / go west / go west / go north / open hatch / go north / go north / go east / go south / take gummy bear"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Your first objective is to open the gate inside the playroom. Then, attempt to go to the west. Th".
The objective part 1 is some text that varies. The objective part 1 is "en, make an effort to take a trip west. Then, venture north. Then, ensure that the hatch within the study is open. And then, go to the north. And then, attempt to travel north. If you can finish that,".
The objective part 2 is some text that varies. The objective part 2 is " go to the east. After that, take a trip south. That done, retrieve the gummy bear from the floor of the kitchen. That's it!".
